...
theme.set_highlights = function(opts)
    ...
    hl(0, '@define', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@variable', { fg = c.vscViolet, bg = 'NONE' })
    hl(0, '@variable.builtin', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@variable.parameter', { fg = c.vscParamBlue, bg = 'NONE' })
    hl(0, '@variable.parameter.reference', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@variable.member', { fg = c.vscViolet, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscViolet, bg = 'NONE' })
    ...
    hl(0, '@operator', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@type', { fg = c.vscMediumBlue, bg = 'NONE' })
    ...
    hl(0, '@tag.builtin', { fg = c.vscYellowOrange, bg = 'NONE' })
    hl(0, '@tag.delimiter', { fg = c.vscGray, bg = 'NONE' })
    hl(0, '@tag.attribute', { fg = c.vscLightRed, bg = 'NONE' })
