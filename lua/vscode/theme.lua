...
theme.set_highlights = function(opts)
    ...
    hl(0, '@constant', { fg = c.vscDarkBlue, bg = 'NONE' })
    ...
    hl(0, '@string', { fg = c.vscLightRed, bg = 'NONE' })
    hl(0, '@character', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@number', { fg = c.vscLightGreen, bg = 'NONE' })
    ...
    hl(0, '@define', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@variable', { fg = c.vscNewBlue, bg = 'NONE' })
    hl(0, '@variable.builtin', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@variable.parameter', { fg = c.vscNewBlue, bg = 'NONE' })
    hl(0, '@variable.parameter.reference', { fg = c.vscNewBlue, bg = 'NONE' })
    hl(0, '@variable.member', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscNewBlue, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@label', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@keyword', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@import', { fg = c.vscViolet, bg = 'NONE' })
    hl(0, '@keyword.export_custom', { fg = c.vscPink, bg = 'NONE' })
    ...
    hl(0, '@keyword.export', { fg = c.vscPink, bg = 'NONE' })
    hl(0, '@keyword.type_alias', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@operator', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@type', { fg = c.vscLightGreen, bg = 'NONE' })
    hl(0, '@type.qualifier', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@import', { fg = c.vscViolet, bg = 'NONE' })
    hl(0, '@structure', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@tag', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, '@tag.builtin', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@tag.delimiter', { fg = c.vscGray, bg = 'NONE' })
    hl(0, '@tag.attribute', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, '@lsp.typemod.function.declaration.typescriptreact', { link = '@function' })
    ...
    hl(0, '@lsp.mod.readonly.typescriptreact', { link = '@constant' })
    hl(0, "@lsp.typemod.function.readonly.typescriptreact", { link = "@function" })
    hl(0, "@lsp.typemod.function.readonly.typescript", { link = "@function" })
    hl(0, "@lsp.typemod.function.readonly.javascript", { link = "@function" })
